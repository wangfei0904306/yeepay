...
public class ZGTUtils {
	...
	//String configFile = "/specialpurpose/ofmaccounting/config/YeePayConfig.properties";
	...
	//后台通知
	public static final String[] NOTIFYAPI_HMAC_ORDER = {"customernumber", "requestid", "code", "notifytype", "externalid", "amount", "cardno", "bankcode", "cardtype", "paydate"};
	...
	static {
		...
		//从配置文件中获取商户编号
		if(customernumber.equals(""))customernumber 	= merchantInfo.getValue("customernumber");
		//从配置文件中获取商户密钥
		if(keyForHmac.equals(""))keyForHmac 		= merchantInfo.getValue("key");
		//aes密钥，为商户密钥的前16位
		keyForAes		= keyForHmac.substring(0, 16);
	}

	public ZGTUtils(String number, String key){
	...
	//get请求
	public static Map<String, String> httpGet(String url, String customernumber, String data) {
		Map<String, String> result		= null;
		...
		System.out.println("paramMap===" + paramMap);
		//get、post请求均可以，在该方法中选用了post请求方式
		String responseBody = HttpClient4Utils.httpGet(url, paramMap, CHARSET, 5*1000);
	...
	//发起GET请求
	public static Map<String, String> httpGet(String url, String data) {
		return httpGet(url, customernumber, data);
	}
